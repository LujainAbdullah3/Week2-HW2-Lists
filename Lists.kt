fun main() {
   ...
   val number = mutableListOf(1,2,3)
    ...
    // Remove
    println("\n================ Remove ================\n")
    println("Befor remove zero : ${numbers}")
   	numbers.remove("zero")
    println("After remove zero : ${numbers}")
    ...
    println("The size of the list names : ${ names.size } ")
    
    // Contains
    println("\n================ Contains ================\n")
    println("contains lujain : ${names.contains("lujain")}")
    ...
    println("After subList : ${names.subList(0,5)}")
